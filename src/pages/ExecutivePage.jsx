...
export default function ExecutivePage() {
  ...
  // Loan Types Management State
  const [loanTypesTab, setLoanTypesTab] = useState('list');
  ...
  const tabs = [
    ...
    { key: 'loan-types', label: `Loan Types (${loanTypes.length})` },

  ...
  return (
    <div className="py-12">
      <div className="mb-8">
        ...
        <p className="text-gray-500">Track revenue, disbursements, and payouts</p>
      </div>
        ...
        <>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-br from-emerald-400 to-teal-600 rounded-3xl p-6 shadow-lg">
              ...
              <h3 className="text-3xl font-bold text-white mt-2">{formatCurrency(revenueData.totalRevenue)}</h3>
            </div>
            <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl p-6 shadow-lg">
              ...
              <h3 className="text-3xl font-bold text-white mt-2">{formatCurrency(revenueData.totalDisbursed)}</h3>
            </div>
            <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-3xl p-6 shadow-lg">
              <p className="text-white/80 text-sm font-medium">Completed Payouts</p>
              <h3 className="text-3xl font-bold text-white mt-2">{revenueData.completedPayouts}</h3>
            </div>
            <div className="bg-gradient-to-br from-orange-400 to-orange-600 rounded-3xl p-6 shadow-lg">
              <p className="text-white/80 text-sm font-medium">Pending Payouts</p>
              <h3 className="text-3xl font-bold text-white mt-2">{revenueData.pendingPayouts}</h3>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 mb-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl">
                <div>
                  <h3 className="font-semibold text-gray-800">Disbursed Loans</h3>
                  <p className="text-sm text-gray-500">{revenueData.disbursedCount} loans fully disbursed</p>
                </div>
                <span className="text-xl font-bold text-green-600">{formatCurrency(revenueData.totalRevenue * 0.6)}</span>
              </div>
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl">
                <div>
                  <h3 className="font-semibold text-gray-800">Partially Disbursed</h3>
                  <p className="text-sm text-gray-500">{revenueData.partiallyDisbursedCount} loans in progress</p>
                </div>
                <span className="text-xl font-bold text-blue-600">{formatCurrency(revenueData.totalRevenue * 0.25)}</span>
              </div>
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl">
                <div>
                  <h3 className="font-semibold text-gray-800">Sanctioned (Pending)</h3>
                  <p className="text-sm text-gray-500">{revenueData.sanctionedCount} loans sanctioned awaiting disbursal</p>
                </div>
                <span className="text-xl font-bold text-orange-600">{formatCurrency(revenueData.totalRevenue * 0.15)}</span>
              </div>
            </div>
          </div>

          {/* Income Summary */}
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 shadow-xl text-white">
            <h2 className="text-xl font-bold mb-4">Revenue Summary</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="border-r border-gray-700 pr-6">
                <p className="text-gray-400 text-sm">Total Loans Processed</p>
                <p className="text-2xl font-bold mt-1">
                  {revenueData.disbursedCount + revenueData.partiallyDisbursedCount + revenueData.sanctionedCount}
                </p>
              </div>
              <div className="border-r border-gray-700 pr-6">
                <p className="text-gray-400 text-sm">Average Revenue per Loan</p>
                <p className="text-2xl font-bold mt-1">

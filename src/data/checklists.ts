...
const firmDocuments = {
  ...
  firmPanCard: createChecklistItem('firm_pan_card', 'Firm Pan Card', 'business_documents'),
  llpAgreement: createChecklistItem('firm_llp_agreement', 'LLP Agreement', 'business_documents'),
  incorporationCert: createChecklistItem('firm_incorporation_cert', 'Incorporation Certificate', 'business_documents'),
  ...
  regCertAoaMoaPvt: createChecklistItem('firm_reg_pvt', 'Registration Certificate, AOA, MOA (Pvt Ltd)', 'business_documents'),
  regCertAoaMoaLLP: createChecklistItem('firm_reg_llp', 'Registration Certificate, AOA, MOA (LLP)', 'business_documents'),
...
export const DECISION_TREE: DecisionTree = {
  ...
  'home_loan|new|non_salaried|indian_resident|llp': [
    ...
    firmDocuments.llpAgreement,
    firmDocuments.incorporationCert,
    firmDocuments.firmPanCard,

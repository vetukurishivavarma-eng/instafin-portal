...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Trigger walking enter animation on mount
    setIsWalking(true);
  ...
  // Math tracking for eye movements
  const lookX = isEmailFocused ? Math.max(-5, Math.min(5, (email.length - 14) * 0.35)) : 0;
  const lookY = isEmailFocused ? 2.5 : 0;
      ...
      <div className="landing-content" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div className="modal" style={{ maxWidth: '420px', width: '90%' }}>
          ...
          <div className="puppy-box">
            <div className={`puppy-svg-container ${hasEntered ? 'entered' : ''} ${isWalking ? 'walking' : ''}`}>
              ...
              <svg width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {isPasswordFocused ? (
                  ...
                  <g>
                    ...
                    {/* Pupils with translation offset */}
                    <g className="puppy-pupil" style={{ transform: `translate(${lookX}px, ${lookY}px)` }}>
                ...
                {/* Raised Paws (Only covers when typing password) */}

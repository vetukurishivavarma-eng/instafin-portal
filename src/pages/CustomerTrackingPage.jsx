  ...
  return (
    <div className="py-12">
      <div className="mb-8">
        ...
        <p className="text-gray-500">Track all customer loan applications across stages</p>
      </div>
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-colors ${filter === 'all' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
            >
            ...
            {STAGES.map(stage => (
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-colors ${filter === stage.key ? stage.color.split(' ').slice(0, 2).join(' ') : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
              >
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-500 bg-white rounded-3xl shadow-xl">No customers found.</div>
      ) : (

        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-md p-6 border-2 border-green-200">
            ...
            <div className="space-y-4">
              ...
              <div className={`mt-4 p-4 rounded-2xl text-white text-center ${eligibleAmount > 0 ? 'bg-gradient-to-r from-blue-600 to-blue-700' : 'bg-gradient-to-r from-red-500 to-red-600'}`}>
                <p className="text-sm opacity-80">Eligible Loan Amount (as per Income)</p>
                <p className="text-3xl font-bold mt-1">
                  {eligibleAmount > 0 ? formatNum(Math.round(eligibleAmount)) : 'NOT ELIGIBLE'}
                </p>
                {eligibleAmount <= 0 && (
                  <p className="text-xs opacity-70 mt-1">Existing EMIs exceed available EMI capacity</p>
                )}
              </div>
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center px-5 py-3 rounded-2xl font-semibold text-sm bg-green-600 text-white hover:bg-green-700 shadow-md hover:shadow-lg transition-all"
          >
